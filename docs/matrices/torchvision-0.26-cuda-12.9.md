# TorchVision 0.26 + CUDA 12.9 — Build Matrix

- **TorchVision**: 0.26.0
- **PyTorch** (matching torch ABI): 2.11.0 — provided by sibling repo `pytorch-nix`
- **CUDA**: 12.9
- **Min driver**: 560+
- **Python versions**: 3.13

Package names follow `torchvision026-python313-cuda12_9-sm{sm}-{isa}`.
...
*Not available at CUDA 12.9: SM110 (requires CUDA 13.0+), SM121 (requires CUDA 13.0+)*
