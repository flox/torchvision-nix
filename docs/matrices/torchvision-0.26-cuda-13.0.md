# TorchVision 0.26 + CUDA 13.0 — Build Matrix
...
Package names follow `torchvision026-python313-cuda13_0-sm{sm}-{isa}`.
...
*Not available at CUDA 13.0: SM61 (capped at CUDA 12.9)*
